...
// Questions
var nodes = [{ "node": 1, "message": "Do you like literary classics", "yes": 2, "no": 3 },
             { "node": 2, "message": "Do you prefer romance over action", "yes": 4, "no": 5 },
             { "node": 3, "message": "Do you love shows about family", "yes": 6, "no": 7 },
             { "node": 4, "message": "Can you stand the sight of blood", "yes": 8, "no": 9 },
             { "node": 5, "message": "Do you like lighthearted shows over serious shows", "yes": 10, "no": 11 },
             { "node": 6, "message": "Do you appreciate shows from the point of view of children", "yes": 12, "no": 13 },
             { "node": 7, "message": "Do you like fantasy shows", "yes": 14, "no": 15 },

// Answers & descriptions
             { "node": 8, "message": "Carmilla", "yes": 0, "no": 0, "description": "Carmilla is a modern college rendition of the novella of the same name by Sheridan Le Fanu" },
             { "node": 9, "message": "Versailles ", "yes": 0, "no": 0, "description": "Versailles is a historical drama about the reign of Louis XIV and the construction of the Versailles Palace"},
             { "node": 10, "message": "All For One", "yes": 0, "no": 0 , "description": "All For One is a webseries that is a modern adaptation of The Three Musketeers"},
             { "node": 11, "message": "Wynonna Earp ", "yes": 0, "no": 0 , "description": "Wynonna Earp is about a woman who has been away from her hometown, Purgatory, for years but returns to reluctantly take on the role that Wyatt Earp’s heir is destined for – demon protector"},
             { "node": 12, "message": "Wandering Son", "yes": 0, "no": 0 , "description": "An anime with a variety of diverse transgender and nonbinary characters with different sexual identities"},
             { "node": 13, "message": "The Fosters ", "yes": 0, "no": 0 , "description": "This drama surrounds the story of two lesbian women and their foster and adoptive children, one of which is also gay"},
             { "node": 14, "message": "The Legend of The Seeker ", "yes": 0, "no": 0 , "description": "Accompanied by the wizard Zedd and mysterious Kahlan, the woodsman Richard Cypher uses his newfound magic powers to help stop a ruthless, power-mad tyrant from unleashing an ancient evil upon the world in this New Zealand/American TV series"},
             { "node": 15, "message": "Couple-ish", "yes": 0, "no": 0 , "description": "Couple-ish is a new LGBTQ webseries about dates, mates, and faking out the government."},
];
...
var welcomeMessage = "Are you ready to watch LGBT shows?";

// This is the message that is repeated if the response to the initial welcome message is not heard
var repeatWelcomeMessage = "Say yes to start the question prompts or no to quit.";

// this is the message that is repeated if Alexa does not hear/understand the reponse to the welcome message
var promptToStartMessage = "Say yes to continue, or no to end the lgbt show finder.";
...
var playAgainMessage = "Say 'tell me more' to hear a short description for this show, or do you want to play again?";

// this is the help message during the setup at the beginning of the game
var helpMessage = "I will ask you some questions that will identify what LGBT show you might like. Want to start now?";
...
var descriptionNotFoundMessage = "Could not find description for show";
